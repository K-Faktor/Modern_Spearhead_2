...
init()
{
	...
	if( !isDefined( level.scr_enable_spearhead_quickmessages ) || !level.scr_enable_spearhead_quickmessages ) {
		...
		level.g_allowvote = 0;
		// Vote menu options
		level.g_allowvote_restartmap = 0;
		level.g_allowvote_nextmap = 0;
		level.g_allowvote_changemap = 0;
		level.g_allowvote_changegametype = 0;
		level.g_allowvote_kickplayer = 0;

		// Clan tags for voting options
		level.g_allowvote_clan_tags = "";
		level.g_allowvote_clan_tags = strtok( level.g_allowvote_clan_tags, " " );
	}
