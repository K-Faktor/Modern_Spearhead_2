...
//******************************************************************************
// Mod      : The OpenWarfare Project... An Open Source Mod for COD4:MW!
...
main()
{
	...
	num = randomInt(4);
	if (num == 1) {
	 	ent.v[ "soundalias" ] = "emt_christmas_heli_radio1";
	} else if (num == 2) {
	 	ent.v[ "soundalias" ] = "emt_christmas_heli_radio2";
	} else if (num == 3) {
	 	ent.v[ "soundalias" ] = "emt_christmas_heli_radio3";
	} else {
	 	ent.v[ "soundalias" ] = "emt_christmas_heli_radio4";
	}
