...
setRuleset()
{
	setDvar( "scr_league_ruleset", "[G13]Clan Practice" );
	setDvar( "sv_hostname", "^3[G13]^2Practice" );
	setDvar( "g_password", "intel13" );
	...
	setDvar( "sv_mapRotation", "map mp_remagen map mp_thehunt_final map mp_argel map mp_cod4malta map mp_bridge map mp_v2 map mp_moh_sfrance_b1 map mp_mohaa_dv" );
